...
public class Exit extends Screen {
	...
	public Exit(Game game) {
		...
		super.texts.add(new GameText(StringScreen.EXIT_GAME.getValue(), (game.getGameWidth() - fullScreenWidth) / 2, 180, Color.WHITE, GameFont.getDefault()));
		...
		super.buttons.add(new GameButton(game, StringScreen.NO.getValue(), rightX, 220, () -> game.updateGameStatus(game.getLastGameStatus())));
	}
